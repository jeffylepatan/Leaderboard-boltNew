    ...
    <div key={animationKey} className="w-full mb-8 animate-fadeInBottom">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:items-end gap-2 md:gap-4">
        ...
        <div className="order-2 md:order-1 flex-1 md:flex-initial transform scale-90 md:scale-100 animate-champion-card animate-champion-card-delay-1">
          <div className="bg-gradient-to-b from-gray-700 to-gray-800 rounded-t-lg p-3 md:p-4 pt-4 md:pt-6 pb-8 md:pb-12 shadow-lg text-center transform hover:scale-105 transition-transform duration-300 border-b-4 border-gray-600 neon-glow">
            {topThree[1].avatar ? (
              <img 
                src={topThree[1].avatar} 
                alt={topThree[1].playerName || topThree[1].alias}
                className="w-16 h-16 rounded-full mx-auto mb-3 border-4 border-gray-600 shadow-lg neon-border"
              />
            ) : (
              <div className="w-16 h-16 rounded-full mx-auto mb-3 bg-gray-600 flex items-center justify-center border-4 border-gray-500 neon-border">
        ...
        <div className="order-1 md:order-2 flex-1 md:flex-initial md:mx-2 md:mx-4 transform scale-100 md:scale-110 z-10 animate-champion-card">
          <div className="bg-gradient-to-b from-yellow-600 to-yellow-700 rounded-t-lg p-4 md:p-6 pt-6 md:pt-8 pb-12 md:pb-16 shadow-xl text-center transform hover:scale-105 transition-transform duration-300 border-b-4 border-yellow-800 neon-glow">
            {topThree[0].avatar ? (
              <img 
                src={topThree[0].avatar} 
                alt={topThree[0].playerName || topThree[0].alias}
                className="w-20 h-20 rounded-full mx-auto mb-4 border-4 border-yellow-500 shadow-lg neon-border"
              />
            ) : (
              <div className="w-20 h-20 rounded-full mx-auto mb-4 bg-yellow-800 flex items-center justify-center border-4 border-yellow-500 neon-border">
        ...
        <div className="order-3 flex-1 md:flex-initial transform scale-90 md:scale-100 animate-champion-card animate-champion-card-delay-2">
          <div className="bg-gradient-to-b from-amber-800 to-amber-900 rounded-t-lg p-3 md:p-4 pt-4 md:pt-6 pb-8 md:pb-12 shadow-lg text-center transform hover:scale-105 transition-transform duration-300 border-b-4 border-amber-900 neon-glow">
            {topThree[2].avatar ? (
              <img 
                src={topThree[2].avatar} 
                alt={topThree[2].playerName || topThree[2].alias}
                className="w-16 h-16 rounded-full mx-auto mb-3 border-4 border-amber-700 shadow-lg neon-border"
              />
            ) : (
              <div className="w-16 h-16 rounded-full mx-auto mb-3 bg-amber-700 flex items-center justify-center border-4 border-amber-600 neon-border">
